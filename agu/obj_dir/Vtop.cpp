...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , start_ntt{vlSymsp->TOP.start_ntt}
    , twiddle_addr{vlSymsp->TOP.twiddle_addr}
    , ntt_done{vlSymsp->TOP.ntt_done}
    , wren_o{vlSymsp->TOP.wren_o}
    , ntt_addr_rd1_o{vlSymsp->TOP.ntt_addr_rd1_o}
    , ntt_addr_rd2_o{vlSymsp->TOP.ntt_addr_rd2_o}
    , intt_addr_rd1_o{vlSymsp->TOP.intt_addr_rd1_o}
    , intt_addr_rd2_o{vlSymsp->TOP.intt_addr_rd2_o}
    , rootp{&(vlSymsp->TOP)}
{
